...
errorCast m e t         = printf "%s -- Cannot cast non-variable expression: %s to %s" m (ppshow e) (ppshow t)
...
errorUniqueTypeParams l = printf "%s -- Only unique type paramteres are allowed" (ppshow l)
