...
2. Copy the following files
    ...
    cp ext/vim/liquid.vim  ~/.vimrc/bundle/syntastic/syntax_checkers/typescript/liquid.vim
    cp ext/vim/liquid.vim  ~/.vimrc/bundle/syntastic/syntax_checkers/javascript/liquid.vim
