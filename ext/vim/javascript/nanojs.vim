...
if exists('g:loaded_syntastic_javascript_nanojs_checker')
    finish
endif
let g:loaded_syntastic_javascript_nanojs_checker = 1


let s:save_cpo = &cpo
set cpo&vim

function! SyntaxCheckers_javascript_nanojs_GetLocList() dict
