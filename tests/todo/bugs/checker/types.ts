...
/*@ qualif KeyVal(x:a, v: c)                 : keyVal(x,"kind") ~~ v */
/*@ qualif ExtClassDeclaration(x:a)          : extends_interface(x,"ClassDeclaration") */
/*@ qualif KVExtClassDeclaration(x:a)        : ((keyVal(x,"kind") ~~ 169) => extends_interface(x,"ClassDeclaration")) */
